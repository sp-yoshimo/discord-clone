                ...
                <div className=" flex flex-col w-full">
                    ...
                    {isImage && (
                        <a
                            ...
                            className=" relative rounded-md mt-2 overflow-hidden border flex items-center bg-secondary h-48 w-48 aspect-square"
                        >
                            <Image
                                src={fileUrl}
                                alt="Content"
                    ...
                    {!fileUrl && !isEditing && (
                        <p className={cn(`text-sm text-zinc-600 mt-1 dark:text-zinc-300`,
